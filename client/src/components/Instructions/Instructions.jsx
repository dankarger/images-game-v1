    ...
    return (
        <div className='instructions'>
            ...
            <div className={isInstructionsVisible ? 'text visible' : 'text hidden'}>
                ...
                <h4> - You can speak (after enabling the mic for this site ) or write (and press Enter) your
                    answer. </h4>
                ...
                <h4> -- The speech detection sometimes make mistake in capturing your speech, but most of the time the
                    result is funny and make part of the fun :) </h4>
                <h4> --- Have Fun --- </h4>
            </div>
